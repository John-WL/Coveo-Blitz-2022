...
public class ITotem implements SpecialBlock {
    @Override
    public StackedTotem pattern() {
        ...
        coordinatePairs.add(new CoordinatePair(3, 0));
        totemAnswers.add(new TotemAnswer(Totem.I, coordinatePairs));
        return new StackedTotem(totemAnswers, new CoordinatePair(4, 1));
    }
