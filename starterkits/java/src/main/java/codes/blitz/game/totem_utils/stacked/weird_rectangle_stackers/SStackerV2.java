...
public class SStackerV2 implements SpecialBlockStacker {
    ...
    static {
        ...
        blockShape1.add(new CoordinatePair(0, 1));
        blockShape1.add(new CoordinatePair(0, 2));
    }
    ...
    static {
        ...
        blockShape2.add(new CoordinatePair(2, 2));
    }
    private static final List<CoordinatePair> blockShape3 = new ArrayList<>();
    static {
        blockShape3.add(new CoordinatePair(1, 2));
        blockShape3.add(new CoordinatePair(1, 3));
        blockShape3.add(new CoordinatePair(0, 3));
        blockShape3.add(new CoordinatePair(0, 4));
    }
    private static final List<CoordinatePair> blockShape4 = new ArrayList<>();
    static {
        blockShape4.add(new CoordinatePair(3, 2));
        blockShape4.add(new CoordinatePair(3, 3));
        blockShape4.add(new CoordinatePair(2, 3));
        blockShape4.add(new CoordinatePair(2, 4));
    }
