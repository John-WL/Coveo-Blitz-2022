...
public class ST2JStacker implements SpecialBlockStacker {
    ...
    public void build4SquaresBlockAt(List<TotemAnswer> totems, int xOffset, int yOffset, int amountToBuild) {
        ...
        jBlock.add(new CoordinatePair(3, 2));
        jBlock.add(new CoordinatePair(3, 1));
        jBlock.add(new CoordinatePair(3, 0));
        jBlock.add(new CoordinatePair(2, 0));
        ...
        sBlock.add(new CoordinatePair(2, 1));
        sBlock.add(new CoordinatePair(1, 1));
        sBlock.add(new CoordinatePair(1, 0));
        sBlock.add(new CoordinatePair(0, 0));
